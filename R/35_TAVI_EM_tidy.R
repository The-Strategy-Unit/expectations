...
# WE ONLY WANT ONE RECORD STROKE SUPER-SPELL (TRANSFERS MAY COMPLICATE)
...
# START HERE --------------------------------------------------------------
# df_tavi_emergency_exclusions |> count(is.na(nhs_no))
